            ...
            child: BlocBuilder<GetProfileCubit, GetProfileState>(
              builder: (context, state) {
                if (state is GetProfileLoadedState) {
                  ...
                  String image = "${state.model.user?.profilePicture}";
                  return Container(
                              ...
                              return GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color:
                                        isSelected ? const Color(0xFF4DC5FD) : const Color.fromRGBO(67, 67, 67, 0.32),
                                              ...
                                              itemBuilder: (context, index) {
                                                ...
                                                return GestureDetector(
                                                    ...
                                                    Navigator.push(
                                                      ...
                                                      MaterialPageRoute(
                                                        builder: (context) => Playlistscreen(
                                                          data: data?.songs,
                                                          text: data?.name ?? "",
                                                          color:AppColor.playlistGradients[
                                                            index % AppColor.playlistGradients.length],
                                                        ),
                                                      ),
                                                    );
                                                  },
                                                  child: Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                      gradient: LinearGradient(
                                                        colors: AppColor.playlistGradients[
                                                            index % AppColor.playlistGradients.length],
                                                        begin: Alignment.topLeft,
                                                        end: Alignment.bottomRight,
                                                      ),
                                            ...
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                ...
                                                image: DecorationImage(
                                                  image: NetworkImage(music.coverImg ?? ""),
                                                  fit: BoxFit.cover,
                                                ),
                                              ),
                                            ),
